...
function main_stod(parentfolder, datafolder, dataname)
...
matfile = strcat(options.folder, '/', dataname, '/', dataname, '.stod', '.mat');
...
matfile = strcat(options.folder, '/', dataname, '/', dataname, '.topic', '.mat');
